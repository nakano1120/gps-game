...
var taro = new Vue({
    ...
    methods:{
      ...
      timer: function(){
        if(document.getElementById("time").value<0 || document.getElementById("sec").value < 0 || document.getElementById("time").value > 999 || document.getElementById("sec").value > 59){
          alert("時間が不正です")
          return
        }
        start = new Date();
